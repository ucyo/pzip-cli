...
def example_for_comparison_with_rust_output():
    vdata = [201,124,53,204,149,106,17,228,241,130,205,118,242,181,14,205,74,17,
...
if __name__ == "__main__":
    if "--example" in sys.argv[1:]:
        example_for_comparison_with_rust_output()
        exit(0)
