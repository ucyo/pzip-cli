...
impl GrayCodeAnalysis{
    pub fn new(num: u32) -> Self {
        ...
        GrayCodeAnalysis{num, lzc, ones, zeros, remaining, residuallength}
    }
}
...
pub fn read_u32(file: &str) -> Vec<u32> {
...
fn positions_by_length(data: &[u32], min: u32, max: u32) {
